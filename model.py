...
def main():
    ...
    # load in 500 songs
    for a in range(50):
        pitches_f, durations_f, volumes_f = read_song('alternative-indie.txt', a)
        ...
        pitches_s, durations_s, volumes_s = read_song('rock_0_4500.txt', a)
    ...
    midi_out = midi_score.write('midi', fp='test_good_music_indierock.mid')
